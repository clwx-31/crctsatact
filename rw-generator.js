(function () {
  ...
  // Twenty-five passages across science, history, social science, the arts, and
  // literary narrative, each supporting a central-idea and a key-detail
  // question. Distractors are built by recombining the passage's own wording
  // into a false relation, so choosing the choice that echoes the text no
  // longer finds the key.
  const CENTRAL_IDEA_PASSAGES = [
    { difficulty: "Easy", text: "Ecologist Priya Nair coated harvested pears with a film made from plant waxes and compared them with untreated pears stored beside them. Over six weeks the coated pears lost moisture more slowly and stayed firm several days longer. The coating washed off in warm water without leaving residue.",
      main: { correct: "A plant-wax coating slowed moisture loss in stored pears without complicating their handling.", distractors: ["Untreated pears stored beside the coated pears stayed firm for several days longer.", "Nair's plant-wax coating preserved the pears by sealing their surfaces permanently.", "Warm water drew moisture out of the coated pears over the six weeks of storage."] },
      detail: { question: "According to the text, what happened when the coated pears were placed in warm water?", correct: "The coating came away without leaving any residue.", distractors: ["The pears lost moisture more quickly than the untreated pears did.", "The coating hardened and sealed the outer surface of the fruit.", "The pears stayed firm for several additional days of storage."] } },
    { difficulty: "Easy", text: "Historian Amina Bell examined logbooks kept by merchant captains between 1780 and 1820. The books record wind, visibility, and sea state at fixed hours each day. Bell found unusual summer fog along one stretch of coast in the same three years across logs from eleven different ships.",
      main: { correct: "Routine navigational records can preserve usable evidence about past coastal weather.", distractors: ["Merchant captains between 1780 and 1820 recorded unusual fog in every summer they sailed.", "Bell's logbooks record wind and visibility but omit any mention of the state of the sea.", "Eleven ships kept logbooks that disagreed about the weather along one stretch of coast."] },
      detail: { question: "According to the text, what did the logbooks record at fixed hours each day?", correct: "Wind, visibility, and the state of the sea.", distractors: ["The names of the eleven ships sailing that stretch of coast.", "The three years in which the unusual summer fog appeared.", "The distance each ship had covered since the previous entry."] } },
    { difficulty: "Easy", text: "Astronomer Elena Park monitored a faint star for eleven months. The star's brightness dipped by a fraction of a percent at intervals of 4.2 days, and each dip lasted about three hours. Park noted that the regularity of the intervals, rather than their depth, made an orbiting body the most economical explanation.",
      main: { correct: "The regular timing of the dips led Park to favor an orbiting body as the explanation.", distractors: ["The depth of the dips rather than their timing pointed Park toward an orbiting body.", "Park monitored the star for eleven months without detecting any change in its brightness.", "Dips lasting 4.2 days at intervals of three hours suggested an orbiting body to Park."] },
      detail: { question: "According to the text, how long did each dip in brightness last?", correct: "About three hours.", distractors: ["About 4.2 days.", "About eleven months.", "A fraction of a percent."] } },
    { difficulty: "Easy", text: "Mara had locked the bakery and reached the corner before she remembered the tray. One row of rolls had settled crooked in the window, and no customer would see it before six. She went back, let herself in, straightened the tray, and stood a moment looking at the case before she locked the door again.",
      main: { correct: "Mara returns to correct a small flaw that nobody else would have noticed.", distractors: ["Mara decides that the crooked tray can wait until customers arrive at six.", "Mara reaches the corner and remembers that she has forgotten to lock the bakery.", "Mara replaces the crooked row of rolls before locking the bakery for the night."] },
      detail: { question: "According to the text, what does Mara do after she returns to the bakery?", correct: "She straightens the tray and looks at the case before leaving.", distractors: ["She waits by the window until a customer notices the display.", "She removes the crooked row of rolls and puts out fresh ones.", "She locks the door and walks back to the corner without entering."] } },
    { difficulty: "Easy", text: "Engineer Sofia Malik laid test panels of porous pavement beside conventional panels in a parking lot. During a two-hour storm the porous panels absorbed about four times as much rainwater. After three winters of grit and salt, the porous panels absorbed roughly half of what they had absorbed when new.",
      main: { correct: "Porous pavement absorbed far more rainwater than conventional pavement but lost capacity as it aged.", distractors: ["Porous pavement absorbed four times as much rainwater after three winters of use.", "Conventional pavement absorbed about half of what it had absorbed when it was new.", "Malik found that grit and salt improved the absorption of the porous panels."] },
      detail: { question: "According to the text, what happened to the porous panels after three winters?", correct: "They took in about half the water they had absorbed when new.", distractors: ["They absorbed four times as much water as the conventional panels.", "They absorbed the same amount of water as when they were first laid.", "They outperformed the conventional panels during a two-hour storm."] } },
    { difficulty: "Easy", text: "Linguist Noah Okafor recorded forty bilingual speakers over twelve weeks. Each speaker was recorded talking with family, with colleagues, and with strangers. Okafor found that individual speakers shifted several features of pronunciation between these settings while using the same language throughout.",
      main: { correct: "Bilingual speakers adjusted their pronunciation according to whom they were addressing.", distractors: ["Bilingual speakers changed their pronunciation when they switched between languages.", "Okafor recorded forty speakers who used a different language with each of three groups.", "Speakers used identical pronunciation with family, colleagues, and strangers alike."] },
      detail: { question: "According to the text, in how many settings was each speaker recorded?", correct: "Three.", distractors: ["Forty.", "Twelve.", "Two."] } },
    { difficulty: "Easy", text: "Musicologist Theo Grant compared four handwritten drafts of a single movement. Across the drafts the principal melody stays intact, but the accompanying rhythm is rewritten each time, growing steadily more irregular. Grant argues that the composer was refining the setting of a tune he had already settled on.",
      main: { correct: "Grant reads the drafts as refinement of a rhythm around a melody that was already fixed.", distractors: ["Grant found that the composer rewrote the principal melody across all four drafts.", "Grant argues that the composer settled the rhythm before choosing the principal melody.", "The four drafts show a rhythm that grew steadily more regular as the work continued."] },
      detail: { question: "According to the text, what changed across the four drafts?", correct: "The rhythm accompanying the melody.", distractors: ["The principal melody of the movement.", "The number of drafts the composer kept.", "The instrument the movement was written for."] } },
    { difficulty: "Easy", text: "Behavioral scientist Imani Cole asked participants to walk for twenty minutes either outdoors along a river path or indoors on a treadmill. Both groups then took the same attention test. The outdoor group scored higher, and the gap was largest among participants who reported the heaviest workload that week.",
      main: { correct: "A short outdoor walk was linked to better attention, most of all for the busiest participants.", distractors: ["Participants who walked indoors on the treadmill scored higher on the attention test.", "The gap between the groups was smallest among the most heavily burdened participants.", "Cole asked participants to take the attention test before rather than after walking."] },
      detail: { question: "According to the text, among which participants was the gap largest?", correct: "Those reporting the heaviest workload that week.", distractors: ["Those who walked indoors on the treadmill.", "Those who walked for longer than twenty minutes.", "Those who scored highest on the attention test."] } },

    { difficulty: "Medium", text: "Archaeologist Daniel Ruiz sorted charred seeds from a single storage pit. The seeds include varieties that ripen in early summer and varieties that ripen in late autumn. Ruiz notes that no single harvest could have produced both, and that the pit was sealed in one episode.",
      main: { correct: "One sealed pit shows that grain from more than one harvest was stored together.", distractors: ["The seeds in the pit came from a single harvest that spanned summer and autumn.", "Ruiz found that the pit was sealed gradually over several successive harvests.", "Varieties ripening in early summer outnumbered those ripening in late autumn."] },
      detail: { question: "According to the text, what does Ruiz say about the sealing of the pit?", correct: "It happened in a single episode.", distractors: ["It happened gradually across several autumns.", "It preserved only the early-summer varieties.", "It could not be dated from the seeds it held."] } },
    { difficulty: "Medium", text: "Marine biologist Luis Ortega measured sediment loss at marsh edges behind restored oyster reefs and at unprotected edges nearby. During three storms the protected edges lost less sediment. Between storms, the two kinds of edge lost sediment at rates that could not be told apart.",
      main: { correct: "The reefs reduced sediment loss during storms without changing it in calm periods.", distractors: ["The reefs reduced sediment loss at the marsh edges during the calm periods between storms.", "Unprotected marsh edges lost less sediment than protected edges during the three storms.", "Ortega measured sediment loss only at the edges protected by the restored reefs."] },
      detail: { question: "According to the text, how did the two kinds of edge compare between storms?", correct: "They lost sediment at rates that could not be told apart.", distractors: ["The protected edges lost markedly less sediment.", "The unprotected edges lost sediment more slowly.", "Neither kind of edge lost any sediment at all."] } },
    { difficulty: "Medium", text: "Urban ecologist Mara Chen mapped afternoon surface temperature across two hundred city blocks. Blocks with dense tree canopy ran cooler than bare blocks, but the difference narrowed sharply where the canopy stood over asphalt rather than grass. Chen concludes that canopy and ground surface act together.",
      main: { correct: "The cooling from tree canopy depended partly on what lay beneath the trees.", distractors: ["Dense tree canopy cooled blocks by the same amount over asphalt and over grass.", "Chen found that the ground surface cooled city blocks regardless of the canopy above it.", "Bare blocks ran cooler than the blocks where canopy stood over asphalt."] },
      detail: { question: "According to the text, where did the temperature difference narrow?", correct: "Where the canopy stood over asphalt.", distractors: ["On blocks that had no tree canopy at all.", "Where the canopy stood over grass.", "Across all two hundred blocks Chen mapped."] } },
    { difficulty: "Medium", text: "All afternoon Eli had shaped the apology, testing it against the fence, the dog, the empty kitchen. At the gate his brother said the weather had turned, and Eli agreed that it had. They talked about the hinge, which had been loose since spring, and about the price of feed.",
      main: { correct: "Eli avoids the apology he prepared by taking up the ordinary subjects his brother raises.", distractors: ["Eli delivers at the gate the apology he has spent the whole afternoon shaping.", "Eli's brother refuses to discuss anything except the weather and the loose hinge.", "Eli's brother apologizes to him before Eli has a chance to speak at all."] },
      detail: { question: "According to the text, what do the brothers discuss at the gate?", correct: "The weather, the loose hinge, and the price of feed.", distractors: ["The apology Eli had spent the afternoon preparing.", "The fence, the dog, and the empty kitchen.", "The spring in which the hinge first came loose."] } },
    { difficulty: "Medium", text: "A team tested a ceramic coating on turbine blades at temperatures from 400 to 1200 degrees. Below 900 degrees the coated blades lost mass more slowly than uncoated ones. Above 1000 degrees the coating cracked, and the coated blades lost mass faster than the uncoated blades did.",
      main: { correct: "The coating protected the blades within a temperature range and became a liability beyond it.", distractors: ["The coating protected the blades more effectively as the temperature increased.", "Uncoated blades lost mass more slowly than coated blades at every temperature tested.", "The team tested the ceramic coating only at temperatures above 1000 degrees."] },
      detail: { question: "According to the text, what happened to the coating above 1000 degrees?", correct: "It cracked.", distractors: ["It slowed the loss of mass from the blades.", "It thickened and sealed the blade surface.", "It behaved as it had below 900 degrees."] } },
    { difficulty: "Medium", text: "Between 1890 and 1910 the city's population doubled while the number of its public wells stayed the same. Records of waterborne illness rise across the same twenty years. A sanitary engineer writing in 1912 attributed the rise to crowding at the wells rather than to any change in the water itself.",
      main: { correct: "A contemporary observer linked rising illness to pressure on unchanged water infrastructure.", distractors: ["The engineer attributed the rise in illness to a change in the quality of the water.", "The number of public wells doubled between 1890 and 1910 along with the population.", "Records of waterborne illness declined over the twenty years the population grew."] },
      detail: { question: "According to the text, what did the sanitary engineer identify as the cause?", correct: "Crowding at the wells.", distractors: ["A change in the water itself.", "The doubling of the city's population.", "The absence of records before 1890."] } },
    { difficulty: "Medium", text: "A botanist grew a fern species at four light levels. Growth increased with light up to a moderate level and then declined. Ferns at the highest light level produced thicker fronds with fewer spores than the ferns grown at the moderate level did.",
      main: { correct: "The fern grew best at moderate light, and stronger light shifted growth away from reproduction.", distractors: ["The fern grew steadily better as the level of light it received increased.", "Ferns at the highest light level produced more spores than ferns at moderate light.", "The botanist grew the fern species at a single light level throughout the study."] },
      detail: { question: "According to the text, how did the highest-light ferns differ from the moderate-light ferns?", correct: "They had thicker fronds and fewer spores.", distractors: ["They had thinner fronds and more spores.", "They grew taller and produced more spores.", "They showed no measurable difference at all."] } },
    { difficulty: "Medium", text: "Painter Wu Lian worked outdoors after 1962 and finished each canvas in one session. Comparison of her studio and outdoor canvases shows that the outdoor works use fewer colors but a wider range of brush sizes. Wu wrote that speed forced her to decide with the brush rather than the palette.",
      main: { correct: "Working quickly outdoors changed both how Wu decided and what her paintings contain.", distractors: ["Wu's outdoor canvases use more colors and a narrower range of brush sizes.", "Wu wrote that working outdoors let her decide with the palette rather than the brush.", "Wu finished her studio canvases in a single session after the year 1962."] },
      detail: { question: "According to the text, how do Wu's outdoor canvases differ from her studio canvases?", correct: "They use fewer colors and a wider range of brush sizes.", distractors: ["They use more colors and a narrower range of brush sizes.", "They were completed over several sessions each.", "They were painted before rather than after 1962."] } },
    { difficulty: "Medium", text: "The letter had been on the hall table since Tuesday. Nadia carried it upstairs each night and brought it down again each morning, and by Friday the envelope had softened at the corners. On Saturday she opened it standing up, in the hall, without taking her coat off.",
      main: { correct: "Nadia's delay and the abruptness of her opening both register how much the letter matters.", distractors: ["Nadia opens the letter on Tuesday, as soon as it arrives on the hall table.", "Nadia leaves the letter untouched on the hall table for the whole of the week.", "Nadia carries the letter upstairs on Saturday and reads it alone in her room."] },
      detail: { question: "According to the text, where does Nadia open the letter?", correct: "Standing in the hall, with her coat still on.", distractors: ["Upstairs in her room on Friday evening.", "At the hall table on Tuesday morning.", "Outside the house before coming in."] } },

    { difficulty: "Hard", text: "A trial reported that a compound reduced pain. Pain was recorded on a self-report scale, and participants knew which group they were in. A second trial, in which the assignment was concealed from participants, found the same reduction using the same scale.",
      main: { correct: "The concealed trial answers the objection that the first result reflected expectation.", distractors: ["Both trials used a self-report scale, so neither can separate pain from expectation.", "The second trial found a smaller reduction than the first once assignment was concealed.", "The first trial concealed assignment while the second let participants know their group."] },
      detail: { question: "According to the text, how did the second trial differ from the first?", correct: "Assignment was concealed from the participants.", distractors: ["It used a different scale to record pain.", "It found no reduction in reported pain.", "It enrolled participants who reported no pain."] } },
    { difficulty: "Hard", text: "Two excavations of the same settlement produced different pictures of its diet. The first sampled hearths, which preserve burned material. The second sampled refuse pits, which preserve bone. Neither method recovers the plant foods that were eaten raw.",
      main: { correct: "Each method's picture of the diet is shaped by what that method is able to preserve.", distractors: ["The two excavations disagreed because one of them sampled the settlement incorrectly.", "Refuse pits and hearths together recover every category of food that was eaten.", "The settlement's diet consisted mainly of plant foods that were eaten raw."] },
      detail: { question: "According to the text, what do both methods fail to recover?", correct: "Plant foods that were eaten raw.", distractors: ["Burned material from the settlement's hearths.", "Animal bone deposited in the refuse pits.", "Evidence of the settlement's storage practices."] } },
    { difficulty: "Hard", text: "A tree-ring chronology places a building's timbers in the 1430s. The chronology was assembled from timbers in the same region, and its earliest section rests on a single beam whose date comes from documentary evidence rather than from rings.",
      main: { correct: "The building's date depends on a documentary anchor at the base of the chronology.", distractors: ["The building's timbers were dated entirely from ring patterns without any documents.", "The chronology's earliest section rests on beams drawn from several different regions.", "Documentary evidence dates the building's own timbers directly to the 1430s."] },
      detail: { question: "According to the text, what is the earliest section of the chronology based on?", correct: "A single beam dated from documents.", distractors: ["Several beams dated from their ring patterns.", "Timbers taken from the building itself.", "Ring patterns recorded across the whole region."] } },
    { difficulty: "Hard", text: "A city's recycling rate rose from 28 to 41 percent after a new collection scheme began. The published measure counts material collected for recycling, not material actually recycled. Contamination at the sorting facility also rose over the same period.",
      main: { correct: "The rise in the published rate may not correspond to a rise in material actually recycled.", distractors: ["The share of collected material that was actually recycled rose from 28 to 41 percent.", "The new scheme reduced contamination at the sorting facility over the same period.", "The city's recycling rate is measured by weighing material after it has been sorted."] },
      detail: { question: "According to the text, what does the published measure count?", correct: "Material collected for recycling.", distractors: ["Material that was successfully recycled.", "Contamination arriving at the sorting facility.", "Households taking part in the collection scheme."] } },
    { difficulty: "Hard", text: "The house had been described to Ines so often that she recognized the wrong things: a stair rail her aunt had mentioned, a window that had been replaced. What she had not been told about, the smell of the hall and the particular cold of the tiles, arrived without warning and undid her.",
      main: { correct: "What Ines was unprepared for affects her more than what she had been told about.", distractors: ["Ines recognizes the house entirely from the descriptions her aunt had given her.", "The stair rail and the replaced window move Ines more than the hall does.", "Ines had been told about the smell of the hall and the cold of the tiles."] },
      detail: { question: "According to the text, what had Ines not been told about?", correct: "The smell of the hall and the cold of the tiles.", distractors: ["The stair rail her aunt had mentioned.", "The window that had been replaced.", "The number of rooms the house contained."] } },
    { difficulty: "Hard", text: "An index ranks hospitals by mortality. Hospitals taking the most complex cases are adjusted for case mix using recorded diagnoses. Diagnoses are recorded more thoroughly at hospitals with larger coding departments, which tend to be the same hospitals.",
      main: { correct: "The adjustment may favor the hospitals whose recording practices are most thorough.", distractors: ["The index adjusts for case mix without any reference to recorded diagnoses.", "Hospitals with larger coding departments take the least complex cases.", "Mortality at complex-case hospitals is unaffected by how diagnoses are recorded."] },
      detail: { question: "According to the text, where are diagnoses recorded most thoroughly?", correct: "At hospitals with larger coding departments.", distractors: ["At hospitals taking the least complex cases.", "At hospitals with the lowest recorded mortality.", "At hospitals that do not adjust for case mix."] } },
    { difficulty: "Hard", text: "A survey of a bird's range found the species at eleven of forty sites. An identical survey a decade earlier found it at nine of the same forty. The earlier survey ran in April; the later one ran in June, when the species is more vocal and easier to detect.",
      main: { correct: "The apparent increase may reflect the timing of the surveys rather than the birds.", distractors: ["The species became easier to detect because its population had increased.", "Both surveys were conducted in the month when the species is most vocal.", "The earlier survey found the species at more sites than the later survey did."] },
      detail: { question: "According to the text, when was the later survey conducted?", correct: "In June.", distractors: ["In April.", "A decade before the earlier survey.", "At nine of the forty sites."] } },
    { difficulty: "Hard", text: "Wages at the plant rose ten percent after the union contract was signed. Over the same two years the plant shifted from three shifts to two, and the workers who remained were on average five years more senior. Seniority pay at the plant rises with years of service.",
      main: { correct: "The average wage could have risen from a change in who was employed rather than from the contract.", distractors: ["The contract raised the wage of every worker at the plant by ten percent.", "The plant added a third shift over the two years following the contract.", "Seniority pay at the plant is unrelated to a worker's years of service."] },
      detail: { question: "According to the text, how did the remaining workers differ?", correct: "They were about five years more senior on average.", distractors: ["They were about five years less senior on average.", "They worked across three shifts rather than two.", "They received no seniority pay under the contract."] } }
  ];

  const CENTRAL_IDEA_CASES = CENTRAL_IDEA_PASSAGES.flatMap((passage) => [
    { difficulty: passage.difficulty, recipe: "central-idea", passage, form: "main" },
    { difficulty: passage.difficulty, recipe: "key-detail", passage, form: "detail" }
  ]);

  function centralIdeasDetails(ctx) {
    const entry = tieredCase(ctx, CENTRAL_IDEA_CASES);
    const { passage } = entry;
    if (entry.form === "main") {
      return item(ctx, {
        recipe: "central-idea", stimulus: passage.text,
        question: "Which choice best states the main idea of the text?",
        correct: passage.main.correct, distractors: passage.main.distractors,
        explanation: "The correct choice states what the passage as a whole establishes. Each other choice reverses a comparison the text makes, promotes a supporting detail over the main point, or asserts something the text does not.",
        parameters: {}
      });
    }
    return item(ctx, {
      recipe: "key-detail", stimulus: passage.text, question: passage.detail.question,
      correct: passage.detail.correct, distractors: passage.detail.distractors,
      explanation: "The correct choice reports what the text actually states. Each other choice draws on the passage's own wording but attaches it to the wrong subject, measure, or moment.",
      parameters: {}
    });
  }
  ...
  // Two forms the SAT uses: a supported-inference question and a completion
  // whose blank ends the passage. Overstatement distractors are phrased without
  // absolute words ("every", "always", "must"), so crossing out absolutes no
  // longer finds the key; each wrong choice reverses the comparison, asserts a
  // cause the evidence does not isolate, or reaches past the observed range.
  const INFERENCE_CASES = [
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "A museum moved several light-sensitive textiles into cases fitted with new ultraviolet filters. Over the following year, color measurements changed less for those textiles than for comparable textiles left under the previous lighting.", correct: "The filters likely reduced one source of the fading.", distractors: ["The filters halted color change in the textiles they protected.", "The previous lighting faded textiles at a steady annual rate.", "The filtered cases admitted more light than the older cases did."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "After a city added protected bicycle lanes on four streets, bicycle counts rose on those streets and on several nearby streets without lanes. Counts in a comparison district some distance away stayed about the same.", correct: "The lanes may have affected cycling beyond the streets that received them.", distractors: ["The lanes affected cycling only on the streets where they were installed.", "Residents near the new lanes gave up other forms of transport for cycling.", "Cycling rose by similar amounts in the project area and the comparison district."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "A novelist's earliest drafts mention a secondary character only twice. In each later draft the scenes involving her grow longer, and in the published book she decides the outcome of the final chapter.", correct: "The novelist gave the character a larger role as she revised.", distractors: ["The novelist settled the character's role before the first draft.", "The character's importance grew only after the book was published.", "The novelist cut the character's scenes while enlarging her role."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "Two groups worked through the same set of puzzles. One received feedback after each attempt; the other received all of it at the end. The first group improved faster during the session, but a week later the two groups scored alike.", correct: "Immediate feedback helped in the short term without producing a lasting edge here.", distractors: ["Delayed feedback produced faster improvement during the working session.", "Feedback timing was unrelated to performance at either point of measurement.", "The advantage from immediate feedback grew larger over the following week."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "Seedlings of one grass species grew equally well in sandy and loamy soil when watered frequently. When the watering was reduced, the seedlings in sandy soil grew considerably less than those in loam.", correct: "Soil type mattered more to growth when water was limited than when it was plentiful.", distractors: ["Soil type governed seedling growth under both of the watering regimes.", "Reduced watering set back seedlings in the two soils to the same degree.", "Seedlings did better in sandy soil whenever water was freely available."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "Archaeologists found charred grain in three storage pits at the settlement. Radiocarbon dates place the pits within a single decade, and the grain in each comes from a different harvest season. The excavators concluded that ______", correct: "the site was occupied across several years rather than briefly.", distractors: ["the settlement was abandoned immediately after a single harvest.", "the three pits were filled during one season of unusual abundance.", "grain storage at the site continued for many centuries afterward."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "A bakery replaced its wheat flour with a blend containing rye. Customers who were told about the change rated the bread lower than customers given the same loaf without being told. Both groups received identical bread. This suggests that ______", correct: "expectation shaped how the customers judged the bread they ate.", distractors: ["the rye blend produced a bread that most customers disliked.", "customers can reliably identify rye flour by taste alone.", "the bakery's original wheat loaf was preferred by every customer."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "Fossil pollen from the lake bed shows oak and hazel arriving within a century of one another. Both species spread from refuges hundreds of kilometers to the south. Neither appears in cores from the preceding two thousand years. Researchers infer that ______", correct: "conditions at the lake became suitable for both species at about the same time.", distractors: ["oak spread northward considerably earlier than hazel did.", "the two species had grown at the lake throughout the preceding period.", "pollen from the lake bed cannot distinguish between the two species."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "A hospital introduced a checklist for one type of operation. Complication rates fell in the following year. Rates for operations that did not use the checklist stayed unchanged over the same period. The result indicates that ______", correct: "the decline was tied to the procedures that adopted the checklist.", distractors: ["complication rates fell across the hospital's entire surgical program.", "the checklist eliminated complications in the operations that used it.", "surgeons using the checklist were more experienced than their colleagues."] },

    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Kestrels hunting over mown motorway verges catch more prey per hour than kestrels hunting over farmland. Vole numbers on the verges are no higher than on the farmland, but the mown strips offer voles almost nothing to shelter beneath.", correct: "The verges make prey easier to catch rather than more abundant.", distractors: ["The verges support a larger vole population than the farmland does.", "Kestrels hunt more efficiently on farmland than along the verges.", "Mowing the verges reduces the number of voles that live along them."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Wages in two neighboring towns tracked each other closely until 1971, then began to separate. The mill in one town closed in 1974. By 1980 the gap between the towns had widened further.", correct: "Something other than the closure began the divergence between the towns.", distractors: ["The mill closure was responsible for the whole of the widening gap.", "Wages in the two towns moved together until the year the mill closed.", "The closure had no bearing on wages in the town where it occurred."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "A model of harbor tides was fitted to eleven years of gauge readings and reproduces them to within a few centimeters. It has not yet been compared with readings from any harbor other than the one it was fitted to.", correct: "Its accuracy at this harbor does not establish how it would perform elsewhere.", distractors: ["The model would reproduce readings at other harbors to similar precision.", "The model's fit to the gauge readings indicates an error in its assumptions.", "Eleven years of readings are too few for any tidal model to be fitted."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Ferns returned to a burned slope within two years, ahead of every other plant. On an adjacent slope cleared by logging rather than fire, ferns returned just as quickly.", correct: "The ferns' speed of return does not depend on the ground having burned.", distractors: ["The ferns tolerate fire better than the other plants on the slope.", "Logging clears ground more thoroughly than fire does on these slopes.", "The ferns returned to the burned slope faster than to the logged one."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Enrollment in an elective rose during each of the six years one instructor taught it. It continued rising for two years after she left, and enrollment in the department's three other electives rose over the same eight years.", correct: "The rise is unlikely to be explained by that instructor alone.", distractors: ["The instructor's teaching had no effect on enrollment in her elective.", "Enrollment in the department's other electives fell while she was teaching.", "Enrollment in the elective declined in the two years after she departed."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "A survey found strong neighborhood support for a proposed park. The interviewers approached people using the existing green space on weekend mornings. Residents who never visit that space were not represented. The finding therefore ______", correct: "may overstate support among the neighborhood as a whole.", distractors: ["shows that the proposed park would go unused by most residents.", "establishes that the neighborhood is evenly divided about the park.", "reflects the views of residents who avoid the existing green space."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "Two dating techniques place a sediment layer in the same century. They disagree about the order in which the individual bands within the layer were laid down. Each technique has been checked against known sequences elsewhere. It follows that ______", correct: "agreement about the century does not settle the sequence within it.", distractors: ["one of the two techniques has been shown to be unreliable.", "the sediment bands were all deposited during a single season.", "the century assigned to the layer should now be treated as doubtful."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "An alloy survived a single eight-ton blow without cracking. The same alloy fractured after ten thousand repetitions of a one-ton load. Engineers testing it for a bridge deck concluded that ______", correct: "its resistance to a single heavy load says little about repeated loading.", distractors: ["the alloy is unsuitable for any structure that carries a heavy load.", "a one-ton load damages the alloy more than an eight-ton load does.", "the alloy would fracture under any load applied more than once."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "A supplement trial reported reduced fatigue. Fatigue was measured by asking participants how tired they felt, and participants knew whether they had received the supplement or the placebo. A reviewer noted that the result ______", correct: "cannot separate the supplement's effect from what participants expected.", distractors: ["was fabricated by the researchers who conducted the trial.", "shows that the supplement has no physiological effect on fatigue.", "would have been stronger had the participants been told nothing."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "Only three of forty surviving pots from a workshop carry the potter's stamp. Stamps were applied to pieces being sent for export. The thirty-seven unstamped pots were all recovered within a day's walk of the kiln. This pattern suggests that the stamp ______", correct: "recorded where a pot was going rather than who had made it.", distractors: ["identified the three pots that the potter made herself.", "was applied only to the pots of the highest quality.", "was omitted from pots that left the workshop unfinished."] },

    { difficulty: "Hard", recipe: "supported-inference", stimulus: "A model reproduces the past century of temperatures closely. It carries eleven free parameters, which were adjusted against that same century until the fit was close. It has not been tested against any period outside the fitting interval.", correct: "The close fit was largely guaranteed by how the model was built.", distractors: ["The model's parameters were adjusted to values that are physically wrong.", "The model will fail to reproduce temperatures outside the fitting interval.", "Eleven parameters are too few to reproduce a century of temperatures."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "Larger brains in one bird family are usually attributed to the demands of social living. Solitary members of the family have brains of comparable size, and those solitary species store food in hundreds of separate caches each autumn.", correct: "The anatomy is consistent with more than one explanation.", distractors: ["Food caching rather than social living accounts for the larger brains.", "Solitary species in the family have larger brains than social species.", "Social living places no memory demands on the birds in this family."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "Habitual short sleepers were excluded from the laboratory studies that established a link between restricted sleep and weakened memory, because their inclusion would have confounded the comparison. Public guidance now applies that finding to habitual short sleepers.", correct: "The guidance extends the finding to a group the studies did not examine.", distractors: ["The laboratory studies were conducted with unsound methodology.", "Habitual short sleepers show no weakening of memory of any kind.", "Restricting sleep in a laboratory has no effect on memory at all."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "A margin of error of three points was reported for a survey. The figure was computed from the achieved sample size. Eight percent of those contacted responded, and repeat surveys using identical sampling but higher response rates have differed by around nine points.", correct: "The stated margin understates the survey's total uncertainty.", distractors: ["The stated margin was calculated incorrectly from the sample size.", "A larger sample would bring the repeat surveys into closer agreement.", "The survey's finding is certainly the opposite of what it reported."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "Every surviving copy of a pamphlet is printed on paper bearing one mill's watermark. That mill operated between 1732 and 1735. Two copies carry manuscript annotations dated 1741.", correct: "The pamphlet was printed in the early 1730s and read at least a decade later.", distractors: ["The pamphlet was printed in 1741, the year of the annotations.", "The annotations were added by the printer before the copies were sold.", "The mill supplied paper to printers throughout the eighteenth century."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "A benchmark was assembled from public examination papers. A model trained on text scraped from the open web in the same years scored ninety percent on it. No test was run on questions written after the training data was collected. The score therefore ______", correct: "does not distinguish command of the subject from recall of the papers.", distractors: ["demonstrates that the model has mastered the subject it was tested on.", "shows that the model performs poorly on questions it has not seen.", "indicates that the benchmark's questions were too easy for the model."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "Isotopes in tooth enamel show that the women buried in a cemetery grew up hundreds of kilometers away, while the men grew up locally. Ethnographic accounts of the region describe brides moving between valleys at marriage. The evidence is therefore ______", correct: "compatible with a marriage practice as well as with a migration.", distractors: ["proof that an entire population moved into the valley together.", "evidence that the enamel signatures were measured incorrectly.", "an indication that the men and women were buried at different times."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "Corals transplanted from a warm lagoon survived a bleaching event. Nursery corals given the same heat-tolerant algae also survived, while nursery corals raised identically without the algae did not. Researchers concluded that ______", correct: "the algae rather than the corals' origin accounts for the tolerance.", distractors: ["corals originating in warm lagoons resist bleaching for genetic reasons.", "nursery conditions determine whether a coral survives a bleaching event.", "the transplanted corals survived because of the depth at which they sat."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "Restaurants that reply to negative reviews recover their ratings faster than those that do not. Repliers also tend to have spare staff, renovated rooms, and money for new menus. No study has yet compared replies with silence at otherwise similar restaurants. The association therefore ______", correct: "does not establish that replying is what produces the recovery.", distractors: ["shows that replying to reviews has no effect on a rating.", "proves that renovation rather than replying drives the recovery.", "means that restaurants without spare staff should not reply."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "A library extended its opening hours into the evening. Visits between six and nine rose steadily over the following months, while the number of daytime visits stayed level.", correct: "The extended hours drew visits that were not simply shifted from the daytime.", distractors: ["Daytime visitors moved their trips to the evening after the change.", "The library's total number of visits fell once the hours changed.", "Evening visitors stayed at the library longer than daytime visitors."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "Two saplings of the same species and size were planted, one in a sheltered courtyard and one on an exposed ridge. After five years the courtyard tree was twice as tall, though both had received identical water and fertilizer.", correct: "Exposure to wind and weather likely slowed the growth on the ridge.", distractors: ["The sapling on the ridge received less water than the one in the courtyard.", "The two saplings belonged to different species despite appearing alike.", "The courtyard tree would have grown just as well if planted on the ridge."] },
    { difficulty: "Easy", recipe: "supported-inference", stimulus: "A factory installed sensors that alert operators when a machine drifts out of tolerance. Scrap output fell by a third over the following quarter, while production volume and staffing stayed unchanged.", correct: "The alerts plausibly contributed to the fall in scrap output.", distractors: ["The factory reduced its scrap by cutting back its production volume.", "Operators had been unable to detect any drift before the sensors arrived.", "Scrap output would have fallen by the same amount without the sensors."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "A trail camera recorded a lynx at the same stream crossing on eleven nights in one winter. No lynx had been photographed anywhere in the region for forty years. Biologists concluded that", correct: "at least one lynx was living in the area that winter.", distractors: ["the region's lynx population had recovered to its historical level.", "lynx had been wholly absent from the region for the past forty years.", "the animal photographed was passing through on a single long journey."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "Bread dough left to rise at fifteen degrees took nearly three times as long as identical dough at twenty-five degrees. Both batches reached the same final volume. The baker concluded that temperature", correct: "affected how quickly the dough rose rather than how far it rose.", distractors: ["determined the final volume that each of the two batches reached.", "had no measurable influence on either the rate or the final volume.", "prevented the cooler batch from rising to its full possible volume."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "Students who ate breakfast at school scored higher on morning tests than those who did not. The breakfast was offered free to families below an income threshold. The researchers cautioned that the difference", correct: "may reflect family circumstances as well as the breakfast itself.", distractors: ["was caused entirely by the nutritional content of the breakfast.", "shows that eating breakfast has no bearing on test performance.", "would disappear if the breakfast were offered to every student."] },
    { difficulty: "Easy", recipe: "logical-completion", stimulus: "A ferry route was shortened by three kilometers when a new pier opened. Crossing times fell by eight minutes, and fuel used per crossing fell by about a fifth. The operator concluded that the new pier", correct: "reduced both the duration and the fuel cost of each crossing.", distractors: ["increased the number of crossings the ferry could make each day.", "lowered fuel use without producing any change in crossing time.", "shortened the route without affecting the vessel's fuel consumption."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "A clinic began sending appointment reminders by text message. Missed appointments fell among patients who had a mobile number on file. Among patients with no number on file, the missed-appointment rate did not change.", correct: "The reminders, rather than a general shift in behavior, reduced the misses.", distractors: ["Patients without mobile numbers began missing more of their appointments.", "The clinic's overall missed-appointment rate was unaffected by the texts.", "Patients with mobile numbers had been more reliable before the change."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "An orchard sprayed half its rows against a fungus and left the other half untreated. Yields in the sprayed rows were higher. The sprayed rows also happened to occupy the better-drained side of the slope.", correct: "The yield difference cannot be attributed to the spraying alone.", distractors: ["Drainage rather than the fungus determined the yield in every row.", "The spray had no effect on the fungus present in the treated rows.", "Yields in the untreated rows exceeded those in the sprayed rows."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Speakers of one language use a distinct vowel in formal settings. Recordings show that the same speakers use it more often when talking to strangers than to relatives, in informal and formal settings alike.", correct: "The vowel tracks the listener more closely than it tracks the setting.", distractors: ["The vowel appears only in settings that the speakers regard as formal.", "Speakers use the vowel more often with relatives than with strangers.", "The vowel has disappeared from informal speech among these speakers."] },
    { difficulty: "Medium", recipe: "supported-inference", stimulus: "Three independent laboratories measured the same mineral sample and reported densities within one percent of each other. A fourth reported a value eight percent higher and later found a calibration fault in its balance.", correct: "The three agreeing measurements are the more trustworthy of the set.", distractors: ["The fourth laboratory's value should be averaged with the other three.", "All four laboratories measured the sample with equivalent accuracy.", "The mineral's density varies according to which laboratory measures it."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "A publisher reissued a novel with a new cover and no changes to the text. Sales the following year were four times those of the year before, and reviews discussed the same content as earlier reviews had. The publisher concluded that", correct: "presentation influenced sales independently of the writing.", distractors: ["the novel's text had been substantially improved for the reissue.", "readers had found the earlier edition's writing difficult to follow.", "reviewers preferred the reissued edition to the original printing."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "Two bridges of the same design were built ten years apart. The older shows corrosion at every joint and the newer shows none. The older stands beside a road salted each winter; the newer does not. Engineers concluded that", correct: "road salt is a likely contributor to the corrosion.", distractors: ["the design used for both bridges is inherently prone to corrosion.", "the newer bridge was built from a fundamentally different alloy.", "corrosion at the joints develops only after ten years of service."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "A researcher found that people who report sleeping well also report exercising regularly. She has no information about which of the two came first for any participant in the sample. Her report should state that the finding", correct: "shows an association whose direction it cannot determine.", distractors: ["establishes that regular exercise produces better sleep.", "shows that sleeping well causes people to exercise regularly.", "indicates that sleep and exercise are unrelated to one another."] },
    { difficulty: "Medium", recipe: "logical-completion", stimulus: "Grain prices in a region began rising four years before three consecutive cold summers. Tree rings confirm that those summers were unusually cold and wet, but harvest records for the earlier years have not survived. Historians concluded that the weather", correct: "cannot account for the price rise that preceded it.", distractors: ["was the sole cause of the shortage that followed in the region.", "had no effect at all on harvests during the years it occurred.", "began several years earlier than the tree rings appear to indicate."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "A drug shortened illness by about a day in healthy adults under sixty. In adults over seventy it halved hospital admissions. The trial in adults over seventy enrolled only patients who had at least one chronic condition.", correct: "The benefit measured in older adults may not extend to healthier ones.", distractors: ["The drug is more effective in older adults than it is in younger adults.", "Chronic conditions prevent the drug from shortening an illness at all.", "The drug provides no benefit to adults under the age of sixty."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "An index of scholarly influence counts citations without adjusting for field. Researchers in one field publish about four papers each year; researchers in another publish fewer than one, and cite older work far more often.", correct: "Comparisons between the two fields on this index would be misleading.", distractors: ["Researchers in the faster-publishing field produce more valuable work.", "Citation counts bear no relation to scholarly influence in either field.", "The slower-publishing field contains fewer genuinely influential researchers."] },
    { difficulty: "Hard", recipe: "supported-inference", stimulus: "A conservation programme reported that a bird's population had doubled. Surveys before the programme covered four sites. Surveys afterward covered eleven, including seven that had never previously been visited by any surveyor.", correct: "Part of the reported increase may reflect the wider survey coverage.", distractors: ["The bird's population declined over the course of the programme.", "The seven new sites held no birds when they were first surveyed.", "The programme had no effect on the bird's population at any site."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "An annotator regularized the spelling throughout a manuscript. The spellings he replaced were entirely standard in the period the manuscript was copied, and the conventions he imposed became standard two centuries later. It follows that the annotations were", correct: "made by a later reader rather than by the original copyist.", distractors: ["written by the copyist as he corrected his own spelling errors.", "added by a contemporary who found the original spelling unclear.", "inserted before the manuscript was first bound and circulated."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "Schools chose whether to adopt a new teaching method. Adopting schools had smaller classes, newer books, and a dedicated coordinator. Scores rose in adopting schools and rose just as much in non-adopting schools with similar resources. The comparison suggests the gain", correct: "tracks the schools' resources rather than the method itself.", distractors: ["was produced by the teaching method in every school that adopted it.", "shows the teaching method lowers scores in well-resourced schools.", "would have been larger had more schools chosen to adopt the method."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "A city reported that a new bus lane cut average journey times by six minutes. The average covered only vehicles using the lane. Cars diverted onto parallel streets were not counted, and journey times on those streets rose. The reported figure therefore", correct: "describes the lane's users rather than the corridor as a whole.", distractors: ["overstates the improvement experienced by buses using the lane.", "shows that journey times rose for every vehicle in the corridor.", "demonstrates that the bus lane made the whole corridor slower."] },
    { difficulty: "Hard", recipe: "logical-completion", stimulus: "Sediment cores show a delta ceased growing during the decade several upstream dams were finished. Sediment accumulating behind those dams since then matches the shortfall measured at the delta. Nothing else in the catchment changed over the period. The cores support the conclusion that ______", correct: "the dams intercepted the sediment the delta had been built from.", distractors: ["the delta had been shrinking for centuries before the dams were built.", "sediment reaching the delta increased after the dams were completed.", "the delta will resume growing once the reservoirs have filled with sediment."] }
  ];

  function inferences(ctx) {
    const entry = tieredCase(ctx, INFERENCE_CASES);
    const isCompletion = entry.recipe === "logical-completion";
    return item(ctx, {
      recipe: entry.recipe,
      stimulus: isCompletion ? `${entry.stimulus} ______` : entry.stimulus,
      question: isCompletion
        ? "Which choice most logically completes the text?"
        : "Which choice is most strongly supported by the text?",
      correct: entry.correct, distractors: entry.distractors,
      explanation: "The correct choice follows from the stated evidence without reaching past it. Each other choice reverses a comparison, asserts a cause the evidence does not isolate, or extends the finding beyond the range the text describes.",
      parameters: {}
    });
  }
